...
**SimpleBounty** is a Paper 26.3 plugin that lets players put up item bounties on other players. Although it was custom built for [minecraftoffline.net](https://www.minecraftoffline.net), it can be used by any server.
